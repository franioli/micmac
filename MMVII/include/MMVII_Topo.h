...
public :
    ...
    void AddPointsFromDataToGCP(cSetMesGndPt &aFullMesGCP, std::vector<cBA_GCP*> * aVGCP); //< get creates points in gcp from points names in data from mAllTopoDataIn, clear mAllTopoDataIn
